...
import { CertificadoModalComponent } from './certificado-alumno-regular-modal/certificado-modal.component';
import Swal from 'sweetalert2';
import { CertificadoAlumnoNotasModalComponent } from './certificado-alumno-notas-modal/certificado-alumno-notas-modal.component';
...
export class CertificadosComponent implements OnInit {
  ...
  vars = [
    ...
    { name: 'Certificado de Notas', template: 'pdf-alumno-notas', link: 'certificado-notas', icon: 'fas fa-file-alt', color: 'bg-purple' },
  ...
  openModal(certificadoObj: any) {
    ...
    if (certificadoObj.template === 'pdf-alumno-regular') {
    ...
    if (certificadoObj.template === 'pdf-alumno-notas') {
      const dialogRef = this.dialog.open(CertificadoAlumnoNotasModalComponent, {
        width: '400px',
        data: { certificado: certificadoObj.name }
      });
